...
导出导出模块基本完全实现 ，修bug 太痛苦了 太痛苦了 太痛苦了 简直要命

### 2023.12.28 冯
前端性能测试，总节点数量10w+，单页面节点100+，除了载入、导出和涉及子系统的递归删除外（大概需要等待10s以内） 其他操作都很流畅，除了一下分析的操作 其他操作的延迟几乎可以忽略不计

**导入性能分析**

在增量导入的模式下，10w+节点导入耗时6秒，主要的时间消耗在并入系统时修改系统id，以及生成导航tree上

![image-20231228195932065](https://buaa007.oss-cn-beijing.aliyuncs.com/imagesimage-20231228195932065.png)

在全局导入的模式下，10w+节点导入耗时5秒，主要时间消耗在vue绑定反序列化的对象与生成导航tree上

![image-20231228200739899](https://buaa007.oss-cn-beijing.aliyuncs.com/imagesimage-20231228200739899.png)

**导出性能分析**

导出10w+节点，耗时约4秒

![image-20231228201016599](https://buaa007.oss-cn-beijing.aliyuncs.com/imagesimage-20231228201016599.png)

**删除子系统**

在10w+节点下，删除子系统耗时约2秒，主要耗时在递归删除相关子系统

![image-20231228201156530](https://buaa007.oss-cn-beijing.aliyuncs.com/imagesimage-20231228201156530.png)

**新增子系统**

在10w+节点下，新增子系统耗时大概2秒

![image-20231228201513167](https://buaa007.oss-cn-beijing.aliyuncs.com/imagesimage-20231228201513167.png)
